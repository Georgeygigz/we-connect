...
SUCCESS_MESSAGES = {
    ...
    'Hot desks with the cancellation reason of {}, fetched successfully',
    "sign_up": "Thank you for registering at We connect. To start using we connect, go to your email and click the confirmation link. Thank you"
}
